let dress = [
  {
    ...
    content: {
      ...
      그냥 일반적인 안감이 아닌 뛰어난 보온성을 선사할
      기모안감이 전체적으로 덧대어 있어 추운날씨에도 
      예쁨과  동시에 보온성도 갖춘 원피스 아이템이 아닐까싶어요♡
      살짝 올라오는 하이넥 디자인으로 넥라인도 여성스럽게 디자인 되었구요
      숄더라인을 따라 프릴 디테일까지 더해져 글램한 바디라인 효과까지 선사해 드려요:D`,

      detail: `전체 허리밴딩으로 활동하기에 편안함 가득하구요.
      안정감 있는 미니 기장으로 레그라인은 보다 길게 표현 해주며,
      잔잔하게 퍼지는 A라인 플레어 디자인으로 
      하체라인을 보다 슬림하게 표현 해준답니다.
      손쉽게 착용하기 좋은 블랙 한 컬러로 준비했어요.`,

      size: `FREE 사이즈로 준비되었어요.
      미니멀한 기장으로 161CM 이하의 체형을 가지신 분들에게
      부담없이 착용가능해 추천해드려요~`
    },
    images: {
      wearing: [
  ...
  },
  {
    ...
    cost: '75,000',
    content: {
      md: `레더 패브릭 자체만으로 트렌디하고
      스페셜한 무드가 느껴지는 원피스예요.

      거칠지 않고 부드러운 페이크 레더 패브릭으로 완성되었어요. 
      특별한 무드가 느껴지는 제품이라 다가오는 연말에 꼭
      추천드리고 싶어 데려온 제품이랍니다 : )

      벨트 세트 구성으로 제작된 제품이라 벨트를 착용해
      더욱 슬림한 실루엣을 연출하셔도 좋답니다.`,
      ...
      바스트 디자인와 라인 디테일로 페미닌하며
      흔하지 않아 소장가치가 높은 제품이예요.
  ...
  },
  {
    ...
    cost: '32,000',
    content: {
      md: `여성스럽게 떨어지는 딥브이넥 디자인으로
      이너에 하이넥티, 니트, 블라우스, 셔츠 등
      어떤 아이템을 매치하느냐에 따라 그 무드가
      다양하게 변신되는 팔색조 매력의 제품!
      흔하지 않은 믹스 트위드 소재로 소장가치 높은 아이템이니, 
      꼭 소장하시길 추천드릴게요-♪`,

      detail: `너무 짧지 않은 미니 기장감으로
      모두 부담 없이 즐길 수 있구요,
      넉넉한 암홀 라인으로 착용시 편안하면서도
      여리한 어깨 라인을 돋보여 드리는 제품이에요.

      스커트라인 부드러운 안감 트리밍으로
      예민한 고객님들께서도 자극없이 입기 좋구요,
      웨스트라인이 높은 하이웨스트 절개로
      롱 앤 슬림한 바디라인을 연출해드린답니다:)
  ...
  },
  {
    ...
    content: {
      ...
      연말룩, 모임룩, 파티룩으로도 잘 어울리고
      윈터시즌 코드 아우터 안에 쏙 입어 주시면
      반전매력을 뽐내실 수 있답니다:-)`,

      detail: `허리는 쏙 들어가고 골반 아래부터
      은은하게 퍼지는 여성스러운 A라인이에요.
      너무 길지도, 짧지도 않게 무릎 위로 살짝
      올라오는 적당한 미디 기장감을 가지고 있어요.

      가슴 윗 부분에 위치한 제원단 스트링으로
      리본을 묶어주면 한층 포인트있는 착용이 가능해요~
      시스루한 프릴 소매가 여리한 손목라인을 연출해드린답니다>.<

      하루 종일 착용해도 구김이 잘 가지 않는 소재로
      언제 어디서나 편안하게 착용하실 수 있어요!`,
  ...
  },
  {
    ...
    content: {
      ...
      분위기있는 감성룩을 완성해드리구요,
      은은하 펄사가 가미되어 움직일때마다
      후광주의, 반사판 효과까지 톡톡히 더해드려요.
      또한, 왼쪽 사이드 맵시있는 실루엣을 연출해줄
      언발 셔링 장식과 밑단 프릴을 더해
      살랑살랑~ 완벽한 실루엣까지 완성-♪`,

      detail: `부드러운 요루쉬폰 소재를 사용하여
      여리여리한 본연의 핏과 요루가공으로
      생활 주름이가도 티가 나지 않아요!

      사이드라인에 셔링 장식을 듬뿍 잡아주어
      올록볼록한 바디라인 군살의 도드라짐까지
      완벽하게 커버해드린답니다♥
      오픈클로징은 백라인 콘솔지퍼 디테일로 도와드리며
      바디부분 안감을 덧대어 비침 걱정없이 편하게 즐기실 수 있어요 :)

      웨딩게스트룩, 봄나들이룩, 데이트룩 등
      사진만 찍으면 인생컷 건지는
      로맨틱한 원피스로 꼭 소장해보세요 *_*`,
  ...
  },
  {
    ...
    cost: '68,000',
    content: {
      md: `명품 못지 않은 품격있는 분위기를
      연출해드리며 로맨틱한 무드를 듬뿍 담은
      슬림라인의 깃털 수술패브릭 드레스랍니다:)

      연말연시 시즌이 다가올 수록 더욱 사랑받는
      매력적인 소재감과 화려한 디테일로
      ...
      깔끔하고 고급스러운 레이스장식 카라,
      배색커프스와 진주 버튼 디테일,
      반짝이는 큐빅으로 장식된 탈부착 브로치로
      더욱 페미닌한 격식룩을 연출해드려요:)

      허리는 잘록하게 잡아주고, 힙라인부터
      자연스럽게 떨어지는 실루엣이 예쁘답니다.`,
  ...
  },
  {
    ...
    content: {
      ...
      입자마자 여신분위기를 자아내는 드레스로
      정말 정말! 강력추천해드리는 제품이에요!
...
let shirt = [
  ...
  },
  {
    ...
    content: {
      ...
      고급스러운 오간자 원단에 실키한 폴리 안감을
      레이어드한 하이 퀄리티의 블라우스예요.
  ...
  },
  {
    ...
    cost: '24,000',
    content: {
      md: `데일리하게 즐기기 좋은 스트라이프 셔츠 입니다.
      소프트한 코튼 원단과 적당한 두께감으로
      간절기 내내 입기 좋은 상품입니다.`,
...
let pullover = [
  ...
  },
  {
    ...
    content: {
      ...
      detail: `편안하게 착용되는 드롭숄더 루즈핏을 연출했어요.
